...
let getPublishConfigs = exports.getPublishConfigs = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, targetSpecificOptions) {
        ...
        }).then(function (publishConfigs) {
            return expandPublishConfigs(packager, publishConfigs);
        });
    });
...
function expandPublishConfigs(packager, publishConfigs) {
    return publishConfigs.map(publishConfig => expandPublishConfig(packager, publishConfig));
}
function expandPublishConfig(packager, publishConfig) {
    return Object.keys(publishConfig).reduce((expandedPublishConfig, key) => {
